function SphericalVertexEigenfunction(
...
> Return k*μ0 as an arb ball, the parameter used for the Legendre
  function.
"""
function mu(u::SphericalVertexEigenfunction{fmpq}, k::Integer = 1)
    u.domain.parent(-k * inv(u.domain.angles[u.vertex]))
end

function mu(u::SphericalVertexEigenfunction{arb}, k::Integer = 1)
...
function norm(domain::SphericalTriangle, u::SphericalVertexEigenfunction, λ::arb)
